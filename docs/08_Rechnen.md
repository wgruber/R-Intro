...
Graphiken sind die beste Form der Darstellung von Ergebnissen! Wenn möglich, sollten Ergebnisse immer durch Graphen dargestellt werden! In RStudio werden die Ergebnisse einer Grafikfunktion im Files-Pane unter Plots ausgegeben.
...
![**Abbildung 27**: Layers in ggplot](Images/08_ggplot_Layers.PNG){ width=50% }
...
![**Abbildung 28**: Anatomie von ggplot](Images/08_ggplot_Anatomy.PNG){ width=50% }
...
![**Abbildung 29**: Aesthetics in ggplot](Images/08_ggplot_Aesthetics.PNG){ width=50% }
